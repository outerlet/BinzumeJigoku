...
public class InAppBillingActivity extends BasicActivity
	...
	private final String TAG_DIALOG_PURCHASE_NOT_SUPPORTED	= "InAppBillingActivity.TAG_DIALOG_PURCHASE_NOT_SUPPORTED";
	private final String TAG_DIALOG_PURCHASE_SUCCEEDED		= "InAppBillingActivity.TAG_DIALOG_PURCHASE_SUCCEEDED";
	private final String TAG_DIALOG_PURCHASE_FAILED			= "InAppBillingActivity.TAG_DIALOG_PURCHASE_FAILED";
	private final String TAG_DIALOG_ALREADY_DONATED			= "InAppBillingActivity.TAG_DIALOG_ALREADY_DONATED";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == getResources().getInteger(R.integer.request_code_execute_purchase)) {
			...
			if (resultCode == RESULT_OK && resCode == 0) {
				showDialogFragment(
						AlertDialogFragment.newInstance(R.string.phrase_confirm, R.string.message_thanks_donation, R.string.phrase_ok),
	...
	public void onAlreadyPurchased(String purchaseToken) {
		showDialogFragment(
				AlertDialogFragment.newInstance(R.string.phrase_confirm, R.string.message_already_donated, R.string.phrase_ok),
